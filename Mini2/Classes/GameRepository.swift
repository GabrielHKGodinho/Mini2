...
class GameRepository: ObservableObject {
    ...
    var games: [Game] = [
        Game(name: "Como é o seu?", icon: "tshirt.fill", color: Color("purple"), endImage: "hows-yours-end", description: "Nesse jogo uma pessoa precisará descobrir o que os outros têm em comum perguntando \"Como é o seu?\"", instructions: [("O mestre escolhido deve se retirar do local ou tampar os ouvidos de modo a não ouvir a conversa dos outros jogadores", "hows-yours1"), ("Os outros jogadores terão de 1 a 2 minutos para decidir algo que todos têm em comum", "hows-yours2"), ("Quando tiverem decidido, o jogador selecionado volta, e precisa fazer a pergunta “Como é o seu?” para cada jogador", "hows-yours3"), ("Após todos os jogadores tiverem respondido, o player sorteado deve tentar adivinhar qual palavra foi escolhida", "hows-yours4")]),
        

        Game(name: "Top 10", icon: "10.circle.fill", color: Color("green"), endImage: "top10-end", description: "Diga o que acha fazer parte do Top 10 enquanto duvida das respostas de seus amigos", instructions: [("O jogador selecionado terá acesso a uma lista de Top 10 de algum tema específico", "top10-1"), ("Cada jogador deverá falar algum item que ele acredita estar na lista", "top10-2"), ("Os outros jogadores podem duvidar se esse item está na lista ou não. Caso esteja, o jogador que duvidou é eliminado. Caso contrário, o jogador que foi desafiado é eliminado", "top10-3")]),
