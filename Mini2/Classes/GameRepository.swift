...
class GameRepository: ObservableObject {
    ...
    var games: [Game] = [
        Game(name: "Como é o seu?", icon: "tshirt.fill", color: Color("red"), description: "Nesse jogo uma pessoa precisará descobrir o que os outros têm em comum perguntando \"Como é o seu?\"", instructions: [("O mestre escolhido ou sorteado deve se retirar do local ou tampar os ouvidos de modo a não ouvir a conversa dos outros jogadores.", ""), ("Os outros jogadores terão 1 a 2 minutos para decidir algo que todos têm em comum.", ""), ("Quando tiverem decidido, o jogador selecionado volta, e precisa fazer a pergunta “Como é o seu?” para cada jogador.", ""), ("Após todos os jogadores derem dicas, o player sorteado deve tentar adivinhar qual palavra foi escolhida.", "")]),
